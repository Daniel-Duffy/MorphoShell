/*
Here we calculate the forces that are minus the gradient
of the elastic shell energy. The huge expressions here 
are generated by a Mathematica script, that spits them
out into a text file, whose contents are then copy-pasted 
in below in the appropriate place.
*/
